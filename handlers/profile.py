...
async def cmd_help(message: Message):
    help_text = (
        "Доступные команды:\n\n"
        "**Настройка профиля:**\n"
        r"\- /set\_profile — Настроить ваш профиль \(вес, рост, возраст, активность, город\)\." + "\n\n"
        "**Логирование воды:**\n"
        r"\- /log\_water \<количество\> — Записать количество выпитой воды \(в мл\)\." + "\n\n"
        "**Логирование еды:**\n"
        r"\- /log\_food \<название еды\> — Записать съеденный продукт и его количество \(в граммах\)\." + "\n\n"
        "**Логирование тренировок:**\n"
        r"\- /log\_workout \<тип тренировки\> \<время \(мин\)\> — Записать тренировку и рассчитать сожженные калории\." + "\n"
        r"Поддерживаемые типы тренировок: бег, ходьба, велосипед, плавание, йога, силовая\." + "\n\n"
        "**Добавление тренировки:**\n"
        r"\- /add\_workout \<название тренировки\> \<расход калорий в минуту\> — Добавить новый тип тренировки\." + "\n\n"
        "**Проверка прогресса:**\n"
        r"\- /check\_progress — Показать текущий прогресс по воде и калориям\." + "\n"
        r"\- /end\_day — Подвести итоги за день\." + "\n"
        r"\- /show\_water\_graph — Показать график потребления воды за последние 7 дней\." + "\n"
        r"\- /show\_calories\_graph — Показать график потребления калорий за последние 7 дней\." + "\n\n"
        "**Помощь:**\n"
        r"\- /help — Показать список команд\."
    )

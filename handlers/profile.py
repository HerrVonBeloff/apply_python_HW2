...
async def cmd_help(message: Message):
    help_text = (
        "Доступные команды:\n\n"
        "**Настройка профиля:**\n"
        "\- /set\_profile — Настроить ваш профиль \(вес, рост, возраст, активность, город\)\.\n\n"
        "**Логирование воды:**\n"
        "\- /log\_water \<количество\> — Записать количество выпитой воды \(в мл\)\.\n\n"
        "**Логирование еды:**\n"
        "\- /log\_food \<название еды\> — Записать съеденный продукт и его количество \(в граммах\)\.\n\n"
        "**Логирование тренировок:**\n"
        "\- /log\_workout \<тип тренировки\> \<время \(мин\)\> — Записать тренировку и рассчитать сожженные калории\.\n"
        "Поддерживаемые типы тренировок: бег, ходьба, велосипед, плавание, йога, силовая\.\n\n"
        "**Добавление тренировки:**\n"
        "\- /add\_workout \<название тренировки\> \<расход калорий в минуту\> — Добавить новый тип тренировки\.\n\n"
        "**Проверка прогресса:**\n"
        "\- /check\_progress — Показать текущий прогресс по воде и калориям\.\n"
        "\- /end\_day — Подвести итоги за день\.\n"
        "\- /show\_water\_graph — Показать график потребления воды за последние 7 дней\.\n"
        "\- /show\_calories\_graph — Показать график потребления калорий за последние 7 дней\.\n\n"
        "**Помощь:**\n"
